...
{
	if (file_exists(BY40Q_THEME_PATH . 'dist/js/' . $slug . '.asset.php')) {
		$asset = require BY40Q_THEME_PATH . 'dist/js/' . $slug . '.asset.php';
	} elseif (file_exists(BY40Q_THEME_PATH . 'dist/css/' . $slug . '.asset.php')) {
		$asset = require BY40Q_THEME_PATH . 'dist/css/' . $slug . '.asset.php';
	} else {
		return null;
	}

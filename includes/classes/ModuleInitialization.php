...
class ModuleInitialization
{
	...
	/**
	 * Get all the By40QTheme plugin classes.
	 *
	 * @return array
	 */
	protected function get_classes()
	{
		...
		$class_finder::setAppRoot(BY40Q_THEME_PATH);
		return $class_finder::getClassesInNamespace('By40QTheme', ClassFinder::RECURSIVE_MODE);
	}

	/**
	 * Initialize all the By40QTheme plugin classes.
	 *
	 * @return void
	 */
	public function init_classes()
	{
		...
		foreach ($this->get_classes() as $class) {
			...
			if (!$reflection_class->isSubclassOf('\By40QTheme\Module')) {
				continue;
			}
	 ...
	 *
	 * @return false|\By40QTheme\Module
	 */
